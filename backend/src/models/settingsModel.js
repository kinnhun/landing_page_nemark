...
class SettingsModel {
  constructor() {
    ...
    this.contactFileName = 'contact-settings.json';
  ...
  async getContactSettings() {
    const settings = await storage.read(this.contactFileName);
    if (!settings) return this.defaultContactSettings;
    
    return {
      ...this.defaultContactSettings,
      ...settings,
      contactInfo: settings.contactInfo || this.defaultContactSettings.contactInfo,
      formFields: settings.formFields || this.defaultContactSettings.formFields
    };
  }
  ...
  async updateContactSettings(data) {
    ...
    return await storage.write(this.contactFileName, toSave);
  }
  ...
  async resetContactSettings() {
    return await storage.write(this.contactFileName, this.defaultContactSettings);
  }
}
