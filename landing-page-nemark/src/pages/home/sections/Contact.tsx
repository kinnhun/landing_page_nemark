  ...
  return (
    <section id="contact" className="py-16 bg-white scroll-mt-20">
      ...
      <div className="container mx-auto px-4" data-aos="fade-up" data-aos-delay="100">
        <div className="mb-8 rounded-lg overflow-hidden shadow-sm" data-aos="fade-up" data-aos-delay="200">
          <iframe
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3 space-y-6">
            <div
              ...
              data-aos-delay="300"
            >
              <div className="w-12 h-12 bg-blue-50 text-blue-500 rounded-full flex items-center justify-center text-xl mr-4 shrink-0">
                <EnvironmentOutlined />
              </div>
              <div>
          ...
          <div className="lg:w-2/3">
            ...
            >
              ...
              <div className="text-center">
                <button 
                  type="submit"
                  className="bg-blue-500 text-white px-8 py-3 rounded hover:bg-blue-600 transition-colors duration-300 font-medium"
                >
                  Gửi Tin Nhắn
                </button>
              </div>
