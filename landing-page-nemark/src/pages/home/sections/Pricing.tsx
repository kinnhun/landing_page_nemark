      ...
      <div className="container mx-auto px-4">
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <StaggerItem className="h-full">
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 flex flex-col h-full hover:shadow-lg transition-shadow duration-300">
              ...
              <a href="#contact" className="block w-full py-3 text-center border border-blue-500 text-blue-500 rounded hover:bg-linear-to-r hover:from-blue-500 hover:to-teal-400 hover:text-white hover:border-transparent transition-all duration-300 font-medium mb-2">Dùng Thử Miễn Phí</a>
          ...
          <StaggerItem className="h-full relative z-10">
            <div className="bg-white p-8 rounded-lg shadow-xl border-2 border-blue-500 flex flex-col relative transform scale-105 h-full">
              <div className="absolute top-0 right-0 bg-linear-to-r from-blue-600 to-teal-500 text-white text-xs font-bold px-3 py-1 rounded-bl-lg rounded-tr-lg uppercase">Phổ Biến</div>
              ...
              <div className="text-4xl font-bold mb-6 bg-clip-text text-transparent bg-linear-to-r from-blue-600 to-teal-500">
                <sup className="text-xl text-blue-500">₫</sup>2.900.000<span className="text-base font-normal text-gray-500"> / tháng</span>
              </div>
              <a href="#contact" className="block w-full py-3 text-center bg-linear-to-r from-blue-600 to-teal-500 text-white rounded hover:shadow-lg hover:scale-105 transition-all duration-300 font-medium mb-2">Đăng Ký Ngay</a>
          ...
          <StaggerItem className="h-full">
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 flex flex-col h-full hover:shadow-lg transition-shadow duration-300">
              ...
              <a href="#contact" className="block w-full py-3 text-center border border-blue-500 text-blue-500 rounded hover:bg-linear-to-r hover:from-blue-500 hover:to-teal-400 hover:text-white hover:border-transparent transition-all duration-300 font-medium mb-2">Nhận Tư Vấn</a>
